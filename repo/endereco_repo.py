...
def inserir_endereco(endereco: Endereco) -> Endereco:
    ...
    cursor.execute(INSERT_ENDERECO, 
        (endereco.id, endereco.logradouro, endereco.numero, endereco.complemento, endereco.bairro, endereco.cidade, endereco.uf, endereco.cep))
...
def excluir_endereco(id: int) -> bool:
    """Exclui uma endereco do banco de dados pelo ID."""
    conexao = obter_conexao()
    cursor = conexao.cursor()
...
def obter_endereco_por_pagina(limite: int, offset: int) -> list[Endereco]:
